...
//(user32.lib/.a, kernel32.lib/.a) #define IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS         //
//[Win32] Don't implement default IME handler. Won't use and link with
//ImmGetContext/ImmSetCompositionWindow. (imm32.lib/.a) #define IMGUI_DISABLE_WIN32_FUNCTIONS //
//[Win32] Won't use and link with any Win32 function (clipboard, ime). #define
//IMGUI_ENABLE_OSX_DEFAULT_CLIPBOARD_FUNCTIONS      // [OSX] Implement default OSX clipboard handler
...
// provided). On Windows you may use vcpkg with 'vcpkg install freetype' + 'vcpkg integrate
// install'.
