...
#define INSTANCE_GETTER                                                                  \
    [[nodiscard]] stormkit::render::Instance &instance() noexcept { return *m_instance); \
    }
#define INSTANCE_CONST_GETTER                                                   \
    [[nodiscard]] const stormkit::render::Instance &instance() const noexcept { \
        return *m_instance;                                                     \
    }
...
#define DEVICE_GETTER \
    [[nodiscard]] stormkit::render::Device &device() noexcept { return *m_device; }
#define DEVICE_CONST_GETTER \
    [[nodiscard]] const stormkit::render::Device &device() const noexcept { return *m_device; }
