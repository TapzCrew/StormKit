...
#include <stormkit/render/resource/Shader.mpp>
    ...
    auto GraphicsPipeline::bake() -> void {
        ...
        auto blend_attachments =
            core::transform(m_state.color_blend_state.attachments, [](const auto &a) {
                return VkPipelineColorBlendAttachmentState {
                    ...
                    .alphaBlendOp        = core::as<VkBlendOp>(a.src_color_blend_factor),
        ...
        const auto dynamic_state =
            VkPipelineDynamicStateCreateInfo { .dynamicStateCount =
                                                   core::as<core::UInt32>(std::size(states)),
        ...
        const auto create_info =
            VkGraphicsPipelineCreateInfo { .sType = VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO,
