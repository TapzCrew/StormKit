...
namespace std {
    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::DescriptorSetLayout>::operator()(
        const render::DescriptorSetLayout &layout) const noexcept -> core::Hash64 {
        return layout.hash();
    }

    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::DescriptorSetLayoutBinding>::operator()(
        const render::DescriptorSetLayoutBinding &binding) const noexcept -> core::Hash64 {
