...
namespace std {
    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::AttachmentDescription>::operator()(
        const render::AttachmentDescription &description) const noexcept -> core::Hash64 {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::Subpass>::operator()(const render::Subpass &description) const noexcept
        -> core::Hash64 {
        auto hash = core::Hash64 { 0 };
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::Subpass::Ref>::operator()(
        const render::Subpass::Ref &description) const noexcept -> core::Hash64 {
        auto hash = core::Hash64 { 0 };
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto hash<render::RenderPassDescription>::operator()(
        const render::RenderPassDescription &description) const noexcept -> core::Hash64 {
        auto hash = core::Hash64 { 0 };
