...
namespace stormkit::render {
    ...
    PhysicalDevice::PhysicalDevice(VkPhysicalDevice vk_physical_device, const Instance &instance)
        ...
        const auto features = [this] {
            auto f = VkPhysicalDeviceFeatures {};
            vkGetPhysicalDeviceFeatures(m_physical_device, &f);
            return f;
        }();
        ...
        m_capabilities.limits.storage_image_sample_counts =
            core::as<SampleCountFlag>(properties.limits.storageImageSampleCounts);
        ...
        const auto extensions = [this] {
            auto extension_count = core::UInt32 { 0 };
            CHECK_VK_ERROR(vkEnumerateDeviceExtensionProperties(m_physical_device,
                                                                nullptr,
                                                                &extension_count,
                                                                nullptr));
        ...
        vkGetPhysicalDeviceMemoryProperties(m_physical_device, &m_vk_memory_properties);
        ...
        const auto queue_family_properties = [this] {
            auto queue_count = core::UInt32 { 0 };
            vkGetPhysicalDeviceQueueFamilyProperties(m_physical_device, &queue_count, nullptr);
            auto q = std::vector<VkQueueFamilyProperties> { queue_count };
            vkGetPhysicalDeviceQueueFamilyProperties(m_physical_device, &queue_count, std::data(q));
            return q;
        }();
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto PhysicalDevice::createLogicalDevice() const -> render::Device {
        STORMKIT_EXPECTS(m_physical_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto PhysicalDevice::allocateLogicalDevice() const -> render::DeviceOwnedPtr {
        STORMKIT_EXPECTS(m_physical_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto PhysicalDevice::allocateRefCountedLogicalDevice() const -> render::DeviceSharedPtr {
        STORMKIT_EXPECTS(m_physical_device != VK_NULL_HANDLE);
