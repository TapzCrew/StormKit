...
namespace stormkit::render {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto WindowSurface::acquireNextFrame() -> Frame {
#if STORMKIT_WSI_ENABLED
        STORMKIT_EXPECTS(m_device);
        STORMKIT_EXPECTS(m_surface);
        STORMKIT_EXPECTS(m_swapchain);
        ...
        const auto image_index = [&] {
            ...
            CHECK_VK_ERROR(vk.vkAcquireNextImageKHR(*m_device,
                                                    m_swapchain,
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto WindowSurface::present(const render::WindowSurface::Frame &frame) -> void {
#if STORMKIT_WSI_ENABLED
        STORMKIT_EXPECTS(m_device);
        STORMKIT_EXPECTS(m_surface);
        STORMKIT_EXPECTS(m_swapchain);
        ...
        const auto present_info = VkPresentInfoKHR { .waitSemaphoreCount = 1,
        ...
        const auto result = vkQueuePresentKHR(m_device->graphicsQueue(), &present_info);
