...
using std::unique_ptr<StormWindowController> = StormWindowController *;
@class StormView;
using View = StormView *;
#else
using std::unique_ptr<StormWindowController> = void *;
using View                          = void *;
#endif
...
namespace storm::window::details {
    class STORMKIT_PRIVATE macOSWindow final: public AbstractWindow {
      ...
      private:
        ...
        std::unique_ptr<StormWindowController> m_controller;
