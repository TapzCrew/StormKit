...
namespace stormkit::gpu {
    ...
    PhysicalDevice::PhysicalDevice(vk::raii::PhysicalDevice physical_device,
        ...
        m_capabilities.limits.framebuffer_color_sample_counts =
            core::as<SampleCountFlag>(properties.limits.framebufferColorSampleCounts.m_mask);
        m_capabilities.limits.framebuffer_depth_sample_counts =
            core::as<SampleCountFlag>(properties.limits.framebufferDepthSampleCounts.m_mask);
        m_capabilities.limits.framebuffer_stencil_sample_counts =
            core::as<SampleCountFlag>(properties.limits.framebufferStencilSampleCounts.m_mask);
        m_capabilities.limits.framebuffer_no_attachments_sample_counts = core::as<SampleCountFlag>(
            properties.limits.framebufferNoAttachmentsSampleCounts.m_mask);
        ...
        m_capabilities.limits.sampled_image_color_sample_counts =
            core::as<SampleCountFlag>(properties.limits.sampledImageColorSampleCounts.m_mask);
        m_capabilities.limits.sampled_image_integer_sample_counts =
            core::as<SampleCountFlag>(properties.limits.sampledImageIntegerSampleCounts.m_mask);
        m_capabilities.limits.sampled_image_depth_sample_counts =
            core::as<SampleCountFlag>(properties.limits.sampledImageDepthSampleCounts.m_mask);
        m_capabilities.limits.sampled_image_stencil_sample_counts =
            core::as<SampleCountFlag>(properties.limits.sampledImageStencilSampleCounts.m_mask);
        m_capabilities.limits.storage_image_sample_counts =
            core::as<SampleCountFlag>(properties.limits.storageImageSampleCounts.m_mask);
        ...
        m_memory_properties =
            m_vk_memory_properties.memoryTypes | std::views::transform([](auto&& property) {
                return core::as<MemoryPropertyFlag>(property.propertyFlags.m_mask);
            }) |
            std::ranges::to<std::vector>();
        ...
        m_queue_families =
            ...
            std::views::transform([](auto&& family) {
                return QueueFamily { .flags = core::as<QueueFlag>(family.queueFlags.m_mask),
