...
namespace stormkit::gpu {
    ...
    inline auto to_string(PhysicalDeviceType type) -> std::string {
        switch (type) {
            ...
            case PhysicalDeviceType::Integrated_GPU: return "Integrated_GPU";
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto to_string(Result result) -> std::string {
        return std::string { vkResultToString(core::as<VkResult>(result)) };
    }
