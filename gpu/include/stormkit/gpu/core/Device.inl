...
namespace stormkit::gpu {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::createVertexBuffer(core::USize size, MemoryPropertyFlag property) const
        -> Buffer {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::allocateVertexBuffer(core::USize size, MemoryPropertyFlag property) const
        -> BufferOwnedPtr {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::createIndexBuffer(core::USize size, MemoryPropertyFlag property) const
        -> Buffer {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::allocateIndexBuffer(core::USize size, MemoryPropertyFlag property) const
        -> BufferOwnedPtr {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::createUniformBuffer(core::USize size, MemoryPropertyFlag property) const
        -> Buffer {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto Device::allocateUniformBuffer(core::USize size, MemoryPropertyFlag property) const
        -> BufferOwnedPtr {
        STORMKIT_EXPECTS(m_device != VK_NULL_HANDLE);
