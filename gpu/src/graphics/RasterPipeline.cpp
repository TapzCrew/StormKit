...
namespace stormkit::gpu {
    /////////////////////////////////////
    /////////////////////////////////////
    RasterPipeline::RasterPipeline(const gpu::Device& device, const PipelineCache *cache) noexcept
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    RasterPipeline::RasterPipeline(RasterPipeline&& other) noexcept
        : Pipeline { std::move(other) }, m_state { std::exchange(other.m_state, {}) },
          m_render_pass { std::exchange(other.m_render_pass, {}) } {
    }

    /////////////////////////////////////
    /////////////////////////////////////
    auto RasterPipeline::operator=(RasterPipeline&& other) noexcept -> RasterPipeline& {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto RasterPipeline::bake() -> void {
        core::expects(m_is_baked == false);
        core::expects(m_render_pass != nullptr);
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto RasterPipeline::bind(CommandBuffer& commandbuffer) const noexcept -> void {
        const auto& vk = device().table();
        vk.vkCmdBindPipeline(commandbuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, m_pipeline);
    }
} // namespace stormkit::gpu
