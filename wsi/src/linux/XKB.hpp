...
namespace stormkit::wsi::details {
    ...
    static inline auto xkb_context_instance        = XKBContextPtr { nullptr };
    static inline auto xkb_context_reference_count = 0u;
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto getXKBContext() noexcept -> XKBContextScoped {
        if (!xkb_context_instance) [[unlikely]] {
            xkb_context_instance = xkb_context_new(XKB_CONTEXT_NO_FLAGS);
            dlog("New xkb context {}", core::as<void *>(xkb_context_instance));
        }

        STORMKIT_EXPECTS(xkb_context_instance);
        return xkb_context_instance;
    }

    /////////////////////////////////////
    /////////////////////////////////////
    inline auto xkbKeyToStormkitKey(xkb_keysym_t key) noexcept -> Key {
        switch (key) {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto stormkitKeyToXKBKey(Key key) noexcept -> xkb_keysym_t {
        switch (key) {
