...
namespace stormkit::wsi::details::wayland {
    ...
    struct Globals {
        ...
        core::HashMap<wl_output *, Monitor> monitors;
    };
    ...
    class WindowImpl: public WindowImplBase {
      public:
        ...
        WindowImpl();
        WindowImpl(std::string title, const core::ExtentU& extent, WindowStyle style);
        ~WindowImpl();
        ...
        auto create(std::string title, const core::ExtentU& extent, WindowStyle style) -> void;
      ...
      private:
        ...
        core::ExtentU m_fullscreen_extent = {};
