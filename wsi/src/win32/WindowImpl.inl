...
namespace stormkit::wsi::details::win32 {
    ...
    inline auto WindowImpl::isOpen() const noexcept -> bool { return m_is_open; }
    inline auto WindowImpl::visible() const noexcept -> bool { return m_is_visible; }

    inline auto WindowImpl::mouseLocked() const noexcept -> bool { return m_mouse_locked; }
    inline auto WindowImpl::mouseHided() const noexcept -> bool { return m_mouse_hided; }
    inline auto WindowImpl::fullscreen() const noexcept -> bool { return m_is_fullscreen; }
    ...
    inline auto WindowImpl::win32Handles() const noexcept -> HWND { return m_window_handle; }
} // namespace stormkit::wsi::details::win32
