...
namespace stormkit::core {
    ...
    template<class T>
    struct STORMKIT_PUBLIC VectorLike: Addable<T>,
                                       Subtractable<T>,
                                       Multiplicable<T>,
                                       Divisible<T>,
                                       MethodCallable<T>,
    ...
    using MoveExtentFOffset = core::NamedType<Vector3f, details::MoveExtentFOffsetTag, VectorLike>;

    /// \group move-offset-types
    /// \unique_name MoveExtentUOffset
    using MoveExtentUOffset = core::NamedType<Vector3u, details::MoveExtentUOffsetTag, VectorLike>;
    ...
    struct Extent {
        ...
        using OrderingType = std::
            conditional_t<std::is_floating_point_v<T>, std::weak_ordering, std::strong_ordering>;
        ...
        [[nodiscard]] constexpr auto operator<=>(const Extent<UnderlyingType>& other) const noexcept
            -> OrderingType;
    ...
    FORMATTER(stormkit::core::MoveOffset2f, "MoveOffset2 {{ .x = {}, .y = {} }}", data->x, data->y)
    ...
    FORMATTER(stormkit::core::MoveOffset2u, "MoveInt322 {{ .x = {}, .y = {} }}", data->x, data->y)
    ...
    FORMATTER(stormkit::core::MoveOffset2i, "MoveOffset2 {{ .x = {}, .y = {} }}", data->x, data->y)
