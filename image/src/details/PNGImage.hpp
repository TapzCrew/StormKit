...
namespace stormkit::image::details {
    [[nodiscard]] auto loadPNG(core::ByteConstSpan data) noexcept
        -> core::Expected<image::Image, image::Image::Error>;

    [[nodiscard]] auto savePNG(const image::Image &image,
                               const std::filesystem::path &filepath) noexcept
        -> core::Expected<void, image::Image::Error>;

    [[nodiscard]] auto savePNG(const image::Image &image) noexcept
